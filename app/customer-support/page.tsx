    ...
    <main className="bg-white text-black">
      ...
      <section className="relative min-h-screen flex flex-col justify-center border-b border-black/10 overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/customer-support-hero.jpg"
            alt="TERREOAK Customer Support and Property Service Assistance"
            fill
            priority
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-[#017a6d] rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex-shrink-0">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-full bg-[#01fa6d] px-10 py-5 text-[18px] font-black text-black hover:opacity-90 transition-all shadow-xl hover:-translate-y-1"
              >
                LOGIN TO PORTAL
              </a>
            </div>
      ...
      >
        <div className="mt-12 max-w-4xl mx-auto space-y-4">
          {[
            ...
            { q: "How does billing work? Can I pay upfront?", a: "We offer both upfront and monthly billing. If you choose to pay your Season Pass upfront, you are eligible for a 10% discount. Alternatively, the pass fee can be split into up to 5 payments with auto-billing on the 1st of every month." }
          ].map((faq, i) => (
