...
export default function Footer() {
  return (
    <footer style={{ background: "#2c2d32", color: "#ffffff", padding: "90px 30px", marginTop: 60 }}>
      <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-4 gap-16">
        {/* Column 1: Brand */}
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-base text-white/70">
            <li><Link href="/landscape-installs" className="hover:text-white transition-colors">Landscape Installs</Link></li>
            <li><Link href="/landscape-design" className="hover:text-white transition-colors">Landscape Design</Link></li>
            ...
            <li><Link href="/lawn-aeration" className="hover:text-white transition-colors">Lawn Aeration</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-base text-white/70">
            ...
            <li>
              <a href="tel:+15877077648" className="hover:text-white transition-colors flex items-center gap-2">
                (587) 707-7648
              </a>
            </li>
            <li>
              <a href="mailto:services@terreoak.ca" className="hover:text-white transition-colors flex items-center gap-2">
