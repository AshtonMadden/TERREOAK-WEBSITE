...
export default function LawnAerationPage() {
        ...
        <main>
            ...
            <section style={styles.hero}>
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Professional lawn aeration in Calgary"
                        fill
                        priority
                ...
                <div style={styles.heroInner} className="pt-56 pb-24 md:pt-64 md:pb-40">
                    ...
                    <h1 style={styles.h1} className="md:!text-[72px] uppercase">
                        ...
                        <span style={{ opacity: 0.75 }}> — Brighter, Greener Lawns.</span>
                    </h1>
                    <p style={styles.subhead}>
                        Relieve soil compaction and allow water, air, and nutrients to reach your grass roots.
                        Professional core aeration for a healthier, more resilient lawn in Calgary.
                    </p>
                    ...
                    <div style={styles.trustGrid}>
                        <div style={styles.trustCard}>
                            <div style={styles.trustTitle}>Deep Core Extraction</div>
                            <div style={styles.trustText}>We pull deep cores to ensure maximum relief from soil compaction.</div>
                        </div>
                        <div style={styles.trustCard}>
                        ...
                        <div style={styles.trustCard}>
                            ...
                            <div style={styles.trustText}>Professional equipment designed for Calgary&apos;s tough soil.</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section style={styles.offerSection}>
                <div style={styles.inner} className="text-center md:text-left">
                    ...
                    <p style={{ ...styles.p, color: "rgba(255,255,255,0.8)", marginLeft: "auto", marginRight: "auto" }} className="md:ml-0 md:mr-0">
                        Professional aeration services to deliver vital nutrients to your lawn&apos;s root zone.
                    </p>
                ...
                <div style={styles.inner}>
                    <div style={{ maxWidth: 800 }}>
                        <h2 style={{ ...styles.h2, fontSize: 36, lineHeight: 1.2, color: "#017a6d" }}>
                            CALGARY LAWN AERATION THAT&apos;S BUILT FOR HEALTHY GROWTH.
                        </h2>
                        <p style={{ ...styles.p, fontSize: 18, marginTop: 24, color: "#333" }}>
                            In Calgary, our clay-heavy soils quickly become compacted, making it difficult for your lawn to breathe, drink, and eat. Our core aeration service uses professional machinery to extract small plugs of soil and thatch, creating pathways for air, water, and nutrients to reach the root zone where they are needed most.
                        </p>
                        <p style={{ ...styles.p, fontSize: 18, marginTop: 16, color: "#333" }}>
                            By relieving this compaction, your lawn can grow deeper, stronger roots, making it more resilient to drought, heat, and Calgary&apos;s unpredictable weather patterns. Consistent annual aeration is one of the most effective ways to maintain a thick, green, and healthy lawn year after year.
                        </p>
            ...
            >
                <div className="grid gap-6 grid-cols-1 md:grid-cols-3 mt-12">
                    {[
                        { step: "01", title: "Book your service", desc: "Select your preferred date window for aeration." },
                        { step: "02", title: "Confirmation & Prep", desc: "We provide instructions on how to prep your lawn." },
                        { step: "03", title: "Professional Aeration", desc: "Our team arrives and pulls deep cores across your lawn." }
                    ].map((p, i) => (
            ...
            <Section title="GUARANTEES" titleClassName="text-[#017a6d] !text-[30.6px] uppercase">
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2 mt-12">
                    <div className="flex flex-col p-8 rounded-xl border border-black/10 transition-all hover:border-[#017a6d] hover:bg-gray-50 group">
                        ...
                        <h3 className="font-black text-xl mb-3">Deep Core Guarantee</h3>
                        <p className="text-black/60 leading-relaxed">
                            We guarantee consistent deep core extraction across your entire lawn area.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col p-8 rounded-xl border border-black/10 transition-all hover:border-[#017a6d] hover:bg-gray-50 group">
                        ...
                        <p className="text-black/60 leading-relaxed">
                            We stick to our scheduled dates to ensure your lawn care stays on track.
                        </p>
                    </div>
                </div>
            </Section>
            ...
            <Section id="seasonal-form" title="REQUEST YOUR SEASONAL SERVICE ESTIMATE" titleClassName="text-[#017a6d]">
                <div className="max-w-4xl mx-auto">
                    <p className="text-center text-lg text-black/60 mb-8 font-medium italic">
                        Submit your details below for a professional Lawn Aeration estimate.
                    </p>
                    <JobberLeadForm
                ...
                <div style={styles.inner}>
                    ...
                    <div style={styles.faq}>
                        <details style={styles.details}>
                            <summary style={styles.summary}>Why should I aerate my lawn?</summary>
                            <p style={styles.pSmall}>
                                Aeration helps solve soil compaction and thatch buildup, allowing oxygen, water, and nutrients to reach the roots of your grass.
                            </p>
                        </details>

                        <details style={styles.details}>
                            <summary style={styles.summary}>What do I do with the plugs?</summary>
                            <p style={styles.pSmall}>
                                Leave them on the lawn! They will break down within 1-2 weeks and return organic matter and nutrients back into the soil.
                            </p>
                        </details>

                        <details style={styles.details}>
                            <summary style={styles.summary}>Should I water before aeration?</summary>
                            <p style={styles.pSmall}>
                                Yes, watering your lawn the day before service helps soften the soil, allowing our machines to extract deeper cores.
                            </p>
                        </details>
                    </div>
