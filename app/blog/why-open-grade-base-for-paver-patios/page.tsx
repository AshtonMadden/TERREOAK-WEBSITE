            ...
            <article className="py-24 mx-auto max-w-4xl px-6">
                <div className="prose prose-xl prose-invert max-w-none space-y-12">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-3xl font-black text-[#017a6d] uppercase tracking-wide">The Calgary Hardscaping Challenge</h2>
                    ...
                    <div className="space-y-8">
                        <h2 className="text-3xl font-black text-[#017a6d] uppercase tracking-wide">Three Critical Advantages for Every Calgary Patio</h2>
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-black/70 font-medium leading-relaxed">
                                        Unlike traditional base which requires watering and vibrating layers over hours, open-grade stone locks together mechanically. It provides a structural, non-settling foundation for Calgary patio and driveway projects.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-black/70 font-medium leading-relaxed">
                                        Even under high-intensity rain, water flows through the base into the subgrade. This prevents the "pudding" effect often seen in wet Calgary springs, ensuring your hardscaping remains rock solid.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-black/70 font-medium leading-relaxed">
                                        While the materials for open-grade bases can be more expensive up front, they virtually eliminate the need for costly "re-leveling" maintenance. It&apos;s a "set it and forget it" solution for high-end Calgary hardscaping.
                                    </p>
                                </div>
                            </div>
                        </div>
